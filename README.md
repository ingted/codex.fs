...
目前狀態：`0.1.0-alpha.3`，仍是早期 alpha。此 package 目前提供：
...
- `codex.fs.cli` dotnet tool package，安裝後命令為 `codex.fs`；
...
dotnet tool install codex.fs.cli --tool-path .\.codex.fs\tool --add-source .\.codex.fs\packs --version 0.1.0-alpha.3
dotnet tool install codex.fs.host.tool --tool-path .\.codex.fs\host-tool --add-source .\.codex.fs\packs --version 0.1.0-alpha.3
...
```powershell
dotnet tool install --global codex.fs.cli --add-source G:\codex.fs\bin\cli-command-packs-20260705012257-alpha3 --version 0.1.0-alpha.3
dotnet tool install --global codex.fs.host.tool --add-source G:\codex.fs\bin\cli-command-packs-20260705012257-alpha3 --version 0.1.0-alpha.3
