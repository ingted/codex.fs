...
| T-HOST-002 | HOST-002 | TC-HOST-002 host boot/health | Integration | Real host runtime with selected PTCS mode | HOST-001/PTCS-002/SESS-001 | health output, non-secret PTCS metadata | Planned | HOST-001 | SD §9 |
