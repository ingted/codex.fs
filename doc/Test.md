...
| T-OPS-002 | OPS-002 | TC-OPS-002 recovery/ack ordering | Ops/Integration | Real PTCS durable handoff plus codex.fs artifact/session persistence boundary | PTCS-003/SESS-001 | Planned: persist selected cursor/run request before execution, persist artifacts/reply evidence before ack, and verify recovery/ack ordering without fake stores | Planned | None | SA §9, SD §11 |
