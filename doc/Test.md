...
| T-HOST-003 | HOST-003 | TC-HOST-003 endpoint contract | Integration/Docs | Real HTTP endpoint with bind address and advertised LAN/routable URI; loopback only in dev profile | HOST-002 | endpoint contract tests, advertised URI check, docs metadata | Planned | None | SD §9, §17 |
