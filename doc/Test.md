...
| T-DOC-002 | DOC-002 | TC-DOC-002 XML docs generated | Docs | Real XML docs from public package compile | DOC-001/CF-002 | XML docs file and missing-docs check | Planned | None | SD §10 |
...
| T-E2E-001 | E2E-001 | TC-E2E-001 / planned `misc/verifyInstalledEngines.fsx` | E2E | Real installed Codex/Agy where available | CDX-003/AGY-003 | probe result with capability map | Planned | None | SD §15 |
