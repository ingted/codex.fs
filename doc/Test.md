...
| T-HOST-003 | HOST-003 | TC-HOST-003 endpoint contract | Integration/Docs | Real selected endpoint protocol | HOST-002 | endpoint contract tests and docs metadata | Blocked | SD-TBD-001 | SD §9, §17 |
| T-DOC-001 | DOC-001 | TC-DOC-001 docs generator spike | Docs | Real tool invocation on sample/public API | CF-001 | selected toolchain note and generated sample | Planned | SD-TBD-006 | SD §10 |
...
| T-DOC-003 | DOC-003 | TC-DOC-003 OpenAPI available | Docs/Integration | Real HTTP host endpoint if HTTP is selected | DOC-001/HOST-003 | OpenAPI JSON + Swagger UI route evidence | Blocked | HOST-003 + SD-TBD-006 | SD §10 |
