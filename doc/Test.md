...
| T-REL-003 | REL-003 | TC-REL-003 host tool start/status | CLI/Package/Host | Real local host tool install and bounded host status/start | REL-002/HOST-003/E2E-002 | host tool install plus `host status` or bounded start/status verifier | Planned | Need host CLI protocol decision | Requirement R-001, SD §9 |
