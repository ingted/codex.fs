...
| T-WEBR-002 | WEBR-002 | `misc/verifyPtcsClassicShellInventory.fsx` | Docs/Investigation | Read real PTCS Host/Dynamic source; no invented UI APIs | API map for `/chat`, `/chat/api/agents`, `/chat/api/thread`, `/chat/api/send`, `/sync/ws`, extension manifest/assets | Planned |
